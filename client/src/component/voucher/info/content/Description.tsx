    ...
    <StyledDescription>
      ...
      <ul className="states">
        <li className="state-item">
          <StateLabel state={{ type: 'voucher', key: 'available' }} css={{ width: '6em' }} />
          <span>사용자끼리 교환이 가능한 상태입니다.</span>
        </li>

        <li className="state-item">
          <StateLabel state={{ type: 'voucher', key: 'trading' }} css={{ width: '6em' }} />
          <span>소유권으로 교환글을 등록한 상태입니다.</span>
        </li>

        <li className="state-item">
          <StateLabel state={{ type: 'voucher', key: 'shipping' }} css={{ width: '6em' }} />
          <span>사용자가 소유권을 실물로 받기 위해 관리자에게 배송요청한 상태입니다.</span>
        </li>

        <li className="state-item">
          <StateLabel state={{ type: 'voucher', key: 'shipped' }} css={{ width: '6em' }} />
