  ...
  return (
    <Card className="ShippingInfoSection" styles={{ marginBottom: "5em"}}>
      ...
      <CardListItem title="배송상태">
        <StateLabel state={{ type: "shipping", key: res.shipping.requestState }} styles={{ width: "6em", margin: "0 0.5em 0.2em 0" }} />
      ...
      <CardListItem title="결제상태">
        <StateLabel state={{ type: "payment", key: res.shipping.paymentState}} styles={{ width: "6em", margin: "0 0.5em 0.2em 0" }} />
