...
### TypeScript
#### 배운 점
이번 프로젝트에 만들면서 `TypeScript` 를 처음으로 사용해보게 되었습니다.  
...
#### 아쉬운 점
`TypeScript`는 `JavaScript`의 Super-Set 언어이기 때문에 대수롭지 않게 생각하고 적용했지만, 타입 지정이나 간단한 제네릭을 제외하고는 많이 활용하지 못한 부분이 아쉽습니다.  
